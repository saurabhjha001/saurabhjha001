...
☁️ Oracle Cloud Infrastructure Generative AI Certified

🚀 Active Contributor to Technical Learning & Innovation Programs

## 📚 Research Publications

🩺 Machine Learning and XAI Approach for Diabetes Prediction

🔐 Privacy Preservation in Federated Learning: A Review

🫁 A Deep Learning Framework for COVID-19 Using Chest X-Ray Images

Published in:
Explainable and Responsible AI in Healthcare: Models, Data, and Future Directions
...
🏅 IBM TechXchange Dev Day Participation

☁️ AWS Certified Developer Associate (Infosys)

⚛️ ReactJS Certification (Infosys)

🔍 AWS CloudTrail Getting Started (Infosys)
